    ...
    return (
        <div className="relative flex h-screen flex-col items-center justify-center bg-teal-500 overflow-hidden">
            <Head>
                ...
                <title>Play with AI - Beyond Tic Tac Toe</title>
                <meta name="title" content="Play with AI - Beyond Tic Tac Toe" />
                ...
                <meta property="og:title" content="Play with AI - Beyond Tic Tac Toe" />
                ...
                <meta property="twitter:title" content="Play with AI - Beyond Tic Tac Toe" />
            ...
            <animated.div style={fadeIn} className="flex flex-col justify-center items-center z-10 absolute w-full h-full ">
                <div className="w-4/5 max-w-lg h-48 bg-white gap-6 flex flex-col justify-center items-center rounded shadow-lg" >
                    <h1 className="text-xl">We are Implementing. . .</h1>
                    <a href="/" onClick={reset} className='border-2 border-neutral-800 px-3 py-1 rounded bg-neutral-700 hover:bg-neutral-800 text-white shadow-md font-semibold transition-colors'>
                        Go Back
                    </a>
                </div>
            </animated.div>
            ...
            <animated.div style={fadeIn}>
                ...
                <div className="shadow-md" >
                    <div className={`w-full h-24 border-4 border-b-0 flex justify-between items-center px-4 ${player == 'x' ? 'bg-teal-600' : 'bg-transparent'}`}>
                        {sizes.map((size, _idx) =>
                            ...
                            {table.map((row, rowIdx) => {
                                return <tr className="grid grid-cols-3">
                                    {row.map((col, colIdx) => {
                                        ...
                                        }} className="text-xl h-24 w-24 border-2 flex items-center justify-center">
                    ...
                    <div className={`w-full h-24 border-4 border-t-0 flex items-center justify-between px-4 ${player == 'o' ? 'bg-teal-600' : 'bg-transparent'}`}>
